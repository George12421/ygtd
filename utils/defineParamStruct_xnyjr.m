function params = defineParamStruct_xnyjr(isDataGen, dataPath, ...
    flowType, caseName, numSamples, numInitialFailures, ...
    loadScaleList, enableSaveData, matpowerFolder, enableRenewables)
...
params.enableRenewables = enableRenewables;
if(isDataGen)
    ...
    elseif(strcmp(caseName, 'IEEE14'))
        params.caseMatpowerStuct = case14;
        params.caseMatpowerStuct.missingCapacityValues = 9900;
